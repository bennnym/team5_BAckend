...
class AirplanesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create airplane" do
    assert_difference('Airplane.count') do
      post airplanes_url, params: { airplane: { bonus: @airplane.bonus, cols: @airplane.cols, name: @airplane.name, rows: @airplane.rows } }
    end
  ...
  test "should update airplane" do
    patch airplane_url(@airplane), params: { airplane: { bonus: @airplane.bonus, cols: @airplane.cols, name: @airplane.name, rows: @airplane.rows } }
