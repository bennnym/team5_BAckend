...
class FlightsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create flight" do
    assert_difference('Flight.count') do
      post flights_url, params: { flight: { date: @flight.date, from: @flight.from, to: @flight.to } }
    end
  ...
  test "should update flight" do
    patch flight_url(@flight), params: { flight: { date: @flight.date, from: @flight.from, to: @flight.to } }
